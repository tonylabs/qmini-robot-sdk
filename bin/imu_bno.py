...
def parse_opt(known=False):
    ...
    parser.add_argument('--port', type=str, default='usb-Silicon_Labs_CP2102_USB_to_UART_Bridge_Controller_0001-if00-port0', help='Serial port of IMU')
...
def read_imu_data(port="usb-Silicon_Labs_CP2102_USB_to_UART_Bridge_Controller_0001-if00-port0", baudrate=921600, timeout=1):
    try:
...
read_imu_data(port="usb-Silicon_Labs_CP2102_USB_to_UART_Bridge_Controller_0001-if00-port0", baudrate=921600, timeout=1)